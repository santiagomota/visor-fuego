...
layers_file <- "assets/aemet/layers.csv"
...
if (!"valid_date" %in% names(manifest)) {
  message("El manifest no tiene columna valid_date. Regenera con v0.6.19:")
  ...
  message("
Nota v0.6.19: en la fuente clásica, down_YYYYMMDD_..._D00 se interpreta como Día 1, válido para YYYYMMDD. D01 es Día 2 y válido para YYYYMMDD + 1.")
