...
# Orden del selector AEMET en Leaflet. Queremos que Península y Baleares
# aparezca antes que Canarias, aunque el paquete SIG de AEMET venga ordenado
# alfabéticamente o se haya generado con un catálogo anterior.
aemet_layer_rank <- function(layer) {
  ...
  if (is.na(dia)) dia <- 0L
  date_chr <- layer$date %||% ""
  paste0(sprintf("%02d", area_rank), "_", sprintf("%02d", tipo_rank), "_", sprintf("%02d", dia), "_", date_chr)
}
